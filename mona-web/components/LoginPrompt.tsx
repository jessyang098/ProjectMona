...
export default function LoginPrompt({
  ...
  return (
    ...
    >
      ...
      <div
        className="mx-4 w-full max-w-md bg-gradient-to-br from-pink-400 via-purple-500 to-indigo-400 p-[1px] rounded-3xl animate-fadeInScale"
      ...
      >
        ...
        <div className="relative w-full rounded-3xl bg-white/95 dark:bg-slate-800/95 p-8">
          ...
          <div className="text-center">
            {/* Icon - Heart with gradient background and pulse animation */}
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-2xl bg-gradient-to-br from-pink-500 to-purple-600 animate-pulse">
