...
const AVATAR_CONFIGS: Record<string, { scale: number; position: [number, number, number]; rotateY: number }> = {
  ...
  "Hana.vrm": { scale: 0.60, position: [0, 0.10, 0], rotateY: Math.PI },
  "/avatars/Hana.vrm": { scale: 0.60, position: [0, 0.10, 0], rotateY: Math.PI },
  // Tora - VRoid Hub model (taller, needs smaller scale)
  "Tora.vrm": { scale: 0.60, position: [0, 0.10, 0], rotateY: Math.PI },
  "/avatars/Tora.vrm": { scale: 0.60, position: [0, 0.10, 0], rotateY: Math.PI },
